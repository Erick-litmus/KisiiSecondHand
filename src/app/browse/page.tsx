      ...
      {error ? (
        <div className="flex flex-col items-center justify-center py-20 px-6">
          ...
          <button
            ...
            className="mt-6 flex items-center gap-2 bg-rose-500 hover:bg-rose-400 text-white font-black text-xs uppercase tracking-widest px-6 py-3 rounded-xl transition-all"
          >
